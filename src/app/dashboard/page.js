    ...
    <div className="responsive-split">
      ...
      <div className="glass-panel" style={{ padding: '1rem', textAlign: 'center', marginBottom: '2rem' }}>
         ...
         <div style={{ marginTop: '0.5rem' }}>
            <h2 style={{ fontSize: '2.5rem', fontWeight: '700' }}>{stats.presentPercentage}%</h2>
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.875rem' }}>Overall Score</p>
         </div>
         ...
         {(() => {
             ...
             return (
                 <div style={{ 
                    ...
                    <h3 style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', marginBottom: '0.5rem', letterSpacing: '0.05em' }}>80% Attendance Goal</h3>
                    {currentPercentage < 80 ? (
                        <p style={{ fontSize: '0.95rem', fontWeight: '500', color: '#fca5a5', lineHeight: '1.4' }}>
                            You need to attend <span style={{ fontWeight: '800', color: '#ef4444' }}>{reqClasses > 0 ? reqClasses : 1}</span> more consecutive periods to reach the 80% minimum.
                        </p>
                    ) : (
                        <p style={{ fontSize: '0.95rem', fontWeight: '500', color: '#86efac', lineHeight: '1.4' }}>
                            You are above 80%! You can afford to miss <span style={{ fontWeight: '800', color: '#4ade80' }}>{safeToMiss > 0 ? safeToMiss : 0}</span> periods.
                        </p>
                    )}
                 </div>
             );
